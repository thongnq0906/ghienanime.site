    ...
    <div class="app-main__inner">
        ...
        <div class="main-card mb-3 card">
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('admin.product.episode.postEdit', [$id, $episode->id]) }}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="vip" value="{{ $episode->vip }}">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="link3" value="{{ $episode->link3 }}">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Link 4: </label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="link4" value="{{ $episode->link4 }}">
                        </div>
                    </div>
        ...
        <form action="{{ route('admin.product.check_full') }}" method="post">
            ...
            <label class="checkbox-inline">
                ...
                Full tập rồi thì nhớ đánh dấu tao
            </label>
        </form>
        <div class="main-card mb-3 card">
            <div class="card-body">
                <div class="list-ep">
                    @foreach ($list as $l)
                        <div class="sotap @if($l->id == $ep_id) active @endif">
                            ...
                            <div class="dell-ep"><a href="{{ route('admin.product.episode.dellEp', $l->id) }}" onclick="return confirm_delete('Bạn có muốn xóa không ?')">x</a></div>
                        </div>
                    @endforeach
                </div>
            </div>
