...
@section('title', ' Xem phim '.$movie->name.' Tập ' .$episode->ep. ' Thuyết Minh Full HD')
@section('title_seo', ' Xem phim '.$movie->name.' Tập ' .$episode->ep. ' Thuyết Minh Full HD')
            ...
            <div class="row ipad-width">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="detail-movie">
                        <div class="title-hd">
                            <a href="{{ route('detail_product', $movie->slug) }}"><h2>{{ $movie->name }} tập {{ $episode->ep }} Thuyết Minh</h2></a>
                            @if (count($phankhac) != 0)
                                <div class="phankhac">
                                    <ul>
                        ...
                        <div class="list-episode nendep" id="cuondep2">
                            <ul>
                                @foreach ($listEp as $l)
                                    <li>
                                        <a href="{{ route('view_movie', [$movie->slug, $l->slug]) }}" class="">{{ $l->ep }}{{ $l->note }}</a>
                                    </li>
                                @endforeach
                            </ul>
                        </div>
                        ...
                        <div class="list-episode nendep" id="cuondep2">
                            <ul>
                                @foreach ($listEpTM as $l)
                                    <li>
                                        <a href="{{ route('view_movie_tm', [$movie->slug, $l->slug]) }}" class="@if($l->id == $episode->id) active @endif">{{ $l->ep }}{{ $l->note }}</a>
                                    </li>
                                @endforeach
                            </ul>
                        </div>
...
@section('script')
    ...
    <script>
        ...
        var $check_vip = "{!! $episode->link1 !!}";
        if ($check_vip.length === 0) {
            startStreaming('EMB', 1);
        } else {
